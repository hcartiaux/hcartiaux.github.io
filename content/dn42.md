...
dn42 is a decentralized network, mainly used as a testbed, which employs common networking protocols (such as BGP, DNS, WHOIS) to reproduce an Internet-like network.
