...
* [2/5] Connect to dn42, set-up the first BGP peering and access dn42 internal services
* [3/5] Multi-homing/Multi-pop - set-up internal BGP peering and use an IGP to split my internal network 
* [4/5] Set-up primary and secondary DNS servers for the zone `hcartiaux.dn42`, and the reverse zones of my IP blocks
* [5/5] Monitor all the network links and create a functional [weathermap](http://www.network-weathermap.com/manual/)
