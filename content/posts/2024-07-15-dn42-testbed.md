---
title: "[dn42] AS4242420263 configuration (Part 1/6)"
date: 2024-07-15
draft: false
...
* I've [created two VMs on my "homelab"](/posts/2024-07-05-dedibox-debian-kvm-terraform/), namely `gw-dn42` and `gw2-dn42`.
...
I want to create a multi-homed network with at least 2 routers, in 6 steps

* [1/6] Request an AS number and IP blocks
* [2/6] Connect to dn42, set-up the first BGP peering and access dn42 internal services
* [3/6] Split my network and use an IGP to propagate the internal routes
* [4/6] Multi-homing/Multi-pop - set-up internal BGP peerings and more external BGP peerings
* [5/6] Set-up primary and secondary DNS servers for the zone `hcartiaux.dn42`, and the reverse zones of my IP blocks
* [6/6] Monitor all the network links and create a functional [weathermap](http://www.network-weathermap.com/manual/)
