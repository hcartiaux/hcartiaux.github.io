...
I've used [ansible to set-up `snmpd`](https://github.com/hcartiaux/ansible/tree/83d880d307ed15af65a4bc96cc4d370ded32064c/roles/snmpd) identically on all my servers (`gw-dn42`, `gw2-dn42` and `librenms-dn42`).
...
snmpd_syscontact:  Hyacinthe Cartiaux <hyacinthe@cartiaux.net>
```
...
syscontact  Hyacinthe Cartiaux <hyacinthe@cartiaux.net>
